            ...
            <div className="bg-white px-7 py-5">
                ...
                <div className="ml-3 flex-1 pr-3 flex justify-between flex-col self-stretch">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <h1
                        className="font-bold text-black text-[22px]"
                  ...
                  <div className=" w-full flex justify-end mt-3">
                    <div className="flex items-end justify-end flex-col w-1/2 py-1 px-2">
                      <h1 className="text-[13px] font-medium text-[#667085]">
                        Purchase date
                      </h1>
              ...
              <div className="mt-2">
                <textarea
                  ...
                  type="text"
                  className="w-full rounded border-[1px] border-black mt-1 px-3 xl:mt-1.5 py-1.5 h-36 font-semibold"
                  style={{ color: "#344054" }}
                />
              </div>
              <div>
                <p
                  className="text-[13px] leading-4 mt-2 font-medium font-semibold "
                  style={{ color: "#344054" }}
                >
          ...
          <div className="border-[1px] border-black rounded relative ">
            ...
            <div className="bg-white px-3 py-5">
              ...
              <div className=" w-full border-y-[1px] border-black flex items-center mt-3">
                ...
                <div className="flex items-end justify-end flex-col w-1/2 py-1 px-2">
                  <h1
                    className="text-[9px] font-medium text-[#667085]"
                    style={{ color: "#667085" }}
                  >
                    Purchase date
                  </h1>
              ...
              <div>
                <p
                  className="text-[9px] leading-3 mt-2 font-medium "
                  style={{ color: "#344054" }}
                >
                  To keep everyone safe on Stake Atlas, we prohibit sharing
                  contact information on messages. Do not share your email,
